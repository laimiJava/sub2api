...
:deep(.input) {
  @apply border-zinc-200 dark:border-zinc-800 bg-white/50 dark:bg-zinc-900/50 transition-all duration-300;
}

:deep(.input:focus) {
  @apply border-zinc-900 dark:border-zinc-100 ring-2 ring-zinc-900/10 dark:ring-zinc-100/10 outline-none shadow-none;
}
</style>
